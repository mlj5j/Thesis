...
\begin{figure}[h]
	\centering
	\includegraphics[width=1.0\linewidth]{Figures/LHC_IPs}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=1.0\linewidth]{Figures/RFbucket}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=1.0\linewidth]{Figures/LHCdipole}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=1.0\linewidth]{Figures/Int_lumi_run2}
