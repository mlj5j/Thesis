...
In the space between the bore of the superconducting magnet and the ECAL is the Hadronic Calorimeter (HCAL).  The HCAL is a sampling calorimeter used for the measurement of hadronic jets and apparent missing transverse energy resulting from neutrinos or exotic particles.  A longitudinal cross-section of the HCAL is shown in Figure \ref{fig:hcallongitudinal}.  

Need to fix the citaiton for this figure

\begin{figure}[h]
	\centering
	\includegraphics[width=0.7\linewidth]{Figures/hcal_longitudinal}
	\caption{Longitudinal view of HCAL}
